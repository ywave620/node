...
process.writevGenericTime = BigInt(0);
function writevGeneric(self, data, cb) {
  ...
  process.writevGenericTime += process.hrtime.bigint() - start;
  return req;
}

process.writeGenericTime = BigInt(0);
function writeGeneric(self, data, encoding, cb) {
  ...
  process.writeGenericTime += process.hrtime.bigint() - start;
  return req;
}
